...
try{
	...
	errMsg= JDOMUtil.selectElement(msgDoc,"/labels/invalidLicense").getText();
}
catch(Exception e)
{
	errMsg="The server license is invalid.  Please contact your administrator and have the license updated.";
}
%>
<p><%=errMsg%></p>
</body>
